                    ...
                    rawJS: {
                        ...
                        perProduct: function (itemdata) {
                            if ("" !== itemdata.salePrice) {
                                itemdata.salePrice = (itemdata.salePrice < itemdata.customPrice) ? itemdata.salePrice : itemdata.customPrice;
                                _4TellBoost.SiteInfo.salePricePrefix = "<span style='color:black'>Sale Price: </span>";
                            } else {
                                itemdata.salePrice = itemdata.customPrice;
                                var whichTier = _4TellBoost.FirstTout.columns.custom.customPrice;
