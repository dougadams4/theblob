(function (_4TellBoost, $, undefined) {
    _4TellBoost.CONFIG = {
        SiteInfo: {
            baseURL: "www.lawsonproducts.com/",
            alias: "LawsonUS",
            GA_UA: "UA-2631789-7",
            platform: "4TellDIY.js",
            custom: true,
            //            addCartBtnAtts: "input type='button' class='button-large' value='Add to Cart' ",
            addCartBtnAtts: "input type='button' value='View Now' ",
            emptyImage: "//www.lawsonproducts.com/images/fpo/250x250_lawson.jpg",
            ...
            ProductDetail: [{
                ...
                rawJS: {
                    preInit: function (tout) {
                        var ds = location.host.match(/^(dev|stage)/);
                        tout.enable = tout.enable && (ds != null && ds.length > 0); 
                    },
                    perProduct: function (itemdata) {
                        if (itemdata.title.length > 80) {
                            itemdata.title = itemdata.title.slice(0, 80);
