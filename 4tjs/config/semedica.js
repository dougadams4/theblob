            ...
            ProductDetail: [{
                ...
                rawJS: {
                    preInit: function (tout) {
                        if (!$(tout.divSelect).length) {
                            var foo = $("#v65-product-parent + table").find("td:first");
                            foo.after("<td valign='top' width='15%'><div id='v65-product-related'></div></td>");
                            foo.attr("width", "85%");
                        }
                    },
                    preDisplay: function (tout) {
                        $(".colors_lines_light").hide();
                        $(tout.divSelect).prevAll("img, br").hide();
                    }
                },
                inCart: false
            }],
