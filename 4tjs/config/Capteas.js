            ...
            Home: [{
                ...
                rawJS: {
                    preInit: function (tout) {
                        //need to clear blockIDs|cartIDs|productIDs|clickStreamIDs|customerID
                        tout.blockIDs = " ";
                        _4TellBoost.Service.cartList = [];
                        _4TellBoost.Service.productList = [];
                        _4TellBoost.UserData.data.Viewed = [];
                        _4TellBoost.Service.customerId = " ";
                    },
                    preDisplay: function () {
                        $('#homeBottom').remove();
                    }
